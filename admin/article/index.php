        ...
        <?php 
          if(isset($_GET['status'])){
            if($_GET['status'] == "add_success"){
              echo "<div class='callout callout-success'><p>Article has been added</p></div>";
              ...
              echo "<div class='callout callout-success'><p>Article has been deleted</p></div>";
            }
            else if($_GET['status'] == "failed3"){
              echo "<div class='callout callout-danger'><p>Failed to delete Article</p></div>";
            }
            else if($_GET['status'] == "failed4"){
              echo "<div class='callout callout-danger'><p>Failed to edit Article</p></div>";
            }
            else if($_GET['status'] == "edit_success"){
              echo "<div class='callout callout-success'><p>Article has been edited</p></div>";
            }
          }
          ?>
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Article
                <small>Manage articles from here</small>
              </h3>
              <!-- tools box -->
              <div class="pull-right box-tools">
              <a href="add.php" class="btn btn-info btn-sm">Add Article</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="../../assets/img/artikel/<?php echo $d["gambar"]?>" target="_blank"><img src="../../assets/img/artikel/<?php echo $d["gambar"]?>" width="30px" alt="<?php echo $d["judul"]?>"></a>
                        </td>
