      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <form role="form" action="addp.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
              <div class="form-group">
                  <label for="exampleInputUsername1">Judul</label>
                  <input type="text" name="judul" class="form-control" id="exampleInputUsername1" placeholder="Masukkan Judul" required>
                </div>
