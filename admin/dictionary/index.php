        ...
        <?php 
          if(isset($_GET['status'])){
            if($_GET['status'] == "add_success"){
              echo "<div class='callout callout-success'><p>Vocabulary has been added</p></div>";
            }else if($_GET['status'] == "failed1"){
              echo "<div class='callout callout-danger'><p>Extension is not allowed</p></div>";
            }else if($_GET['status'] == "failed2"){
              echo "<div class='callout callout-danger'><p>File size is too high</p></div>";
            }
            else if($_GET['status'] == "deletesuccess"){
              echo "<div class='callout callout-success'><p>Vocabulary has been deleted</p></div>";
            }
            else if($_GET['status'] == "failed3"){
              echo "<div class='callout callout-danger'><p>Failed to delete Vocabulary</p></div>";
            }
            else if($_GET['status'] == "failed4"){
              echo "<div class='callout callout-danger'><p>Failed to edit Vocabulary</p></div>";
            }
            else if($_GET['status'] == "edit_success"){
              echo "<div class='callout callout-success'><p>Vocabulary has been edited</p></div>";
            }
          }
          ?>
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Dictionary
                <small>Manage vocabulary from here</small>
              </h3>
              <!-- tools box -->
              <div class="pull-right box-tools">
              <a href="add.php" class="btn btn-info btn-sm">Add Vocabulary</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="../../assets/img/kamus/<?php echo $d["gambar"]?>" target="_blank"><img src="../../assets/img/kamus/<?php echo $d["gambar"]?>" width="30px" alt="<?php echo $d["judul"]?>"></a>
                        </td>
                        <td class="project-actions text-right">
                            <a class="btn btn-info btn-sm" href="edit.php?id=<?php echo $d['id']; ?>">    
                                Edit
                            </a>
                            <a class="btn btn-success btn-sm" href="view.php?id=<?php echo $d['id']; ?>">    
                                View
                            </a>
                            <a class="btn btn-danger btn-sm" href="delete.php?id=<?php echo $d['id']; ?>">    
                                Delete
                            </a>
                        </td>
                    </tr>
