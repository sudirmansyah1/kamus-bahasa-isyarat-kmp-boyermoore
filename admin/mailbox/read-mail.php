<?php 
    ...
    mysqli_query($koneksi, "UPDATE mailbox SET `read`='y' WHERE `id`='$id'");
	?>
<!DOCTYPE html>
<html>
<head>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div id="printableArea" class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3><?php echo $datas['subject']?></h3>
                <h5>From: <a href="mailto:<?php echo $datas['email']?>"><?php echo $datas['email']?></a>
                  <span class="mailbox-read-time pull-right"><?php echo $datas['date']?></span></h5>
              </div>
              <!-- /.mailbox-read-info -->
              
              <!-- /.mailbox-controls -->
              <div class="mailbox-read-message">
                <p><?php echo $datas['message']?></p>
              </div>
            ...
            <div class="box-footer">
              <div class="pull-right">
                <a href="reply.php?id=<?php echo $datas['id']?>" class="btn btn-default"><i class="fa fa-reply"></i> Reply</a>
              </div>
              <a href="delete.php?id=<?php echo $datas['id']?>" class="btn btn-default"><i class="fa fa-trash-o"></i> Delete</a>
