          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="read.php"><i class="fa fa-envelope-open-o"></i> Readed</a></li>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-hover table-striped">
                ...
                <?php 
                    $no = 1;
                    $data = mysqli_query($koneksi,"SELECT * FROM mailbox WHERE `read` = 'y' AND `replied` = 'n' ORDER BY `id` DESC");
