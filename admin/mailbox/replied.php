      ...
      <?php 
          if(isset($_GET['status'])){
            if($_GET['status'] == "success"){
              echo "<div class='callout callout-success'><p>Mailbox has been replied</p></div>";
            }else if($_GET['status'] == "failed"){
              echo "<div class='callout callout-danger'><p>Failed to reply mailbox</p></div>";
            }
            else if($_GET['status'] == "deletesuccess"){
              echo "<div class='callout callout-success'><p>Mailbox has been deleted</p></div>";
            }
            else if($_GET['status'] == "failed3"){
              echo "<div class='callout callout-danger'><p>Failed to delete mailbox</p></div>";
            }
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="replied.php"><i class="fa  fa-paper-plane-o"></i> Replied</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-hover table-striped">
                ...
                <?php 
                    $no = 1;
                    $data = mysqli_query($koneksi,"SELECT * FROM mailbox WHERE `replied` = 'y' ORDER BY `id` DESC");
                    while($d = mysqli_fetch_array($data)){                        
                    ?>
                    <tr <?php if($d['read']=='y'){ echo "style='background-color: #f2f2f2;'";} else {echo "style='background-color: #fff;'";}?>>
