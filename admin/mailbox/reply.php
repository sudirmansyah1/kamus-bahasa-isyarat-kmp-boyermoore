<?php 
    ...
    $id = $_GET['id'];
    $sqls = "SELECT * FROM mailbox WHERE `id` = '$id'";
      ...
      <div class="row">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="index.php"><i class="fa fa-inbox"></i> Inbox <?php if ($data5["count"] > 0){?>
                <span class="label label-primary pull-right"><?php echo $data5["count"]?></span><?php }?></a></li>
                <li><a href="unread.php"><i class="fa fa-envelope-o"></i> Unread <?php if ($data5["count"] > 0){?><span class="label label-success pull-right"><?php echo $data5["count"]?></span><?php }?></a></li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Reply a message</h3>
            </div>
            <form action="replyp.php" method="post">
            <!-- /.box-header -->
            
            <div class="box-body">
              <div class="form-group">
              <input type="hidden" class="form-control" id="email" name="name" value="<?php echo $datas['name'];?>" required>
              <input type="hidden" class="form-control" id="email" name="id" value="<?php echo $datas['id'];?>" required>
              <input type="hidden" class="form-control" id="email" name="subjectx" value="<?php echo $datas['subject'];?>" required>
                <input class="form-control" name="to" value="<?php echo $datas['email']?>" placeholder="To:" readonly required>
              </div>
              <div class="form-group">
                <input class="form-control" name="subject" value="ISL Re: <?php echo $datas['subject']?>"placeholder="Subject:" readonly required>
              </div>
              <div class="form-group">
            ...
            <div class="box-footer">
              ...
              <a href="javascript:history.back()"" class="btn btn-default"><i class="fa fa-times"></i> Discard</a>
            </div>
            </form>
            <!-- /.box-footer -->
          </div>
