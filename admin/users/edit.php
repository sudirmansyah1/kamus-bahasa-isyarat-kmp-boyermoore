          ...
          <div class="box box-success">
            ...
            <form role="form" action="editp.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="username" class="form-control" id="exampleInputUsername1" placeholder="Enter username" value="<?php echo $datas['username'];?>" required>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Email address</label>
                  <input type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email" value="<?php echo $datas['email'];?>" required>
                </div>
                <div class="form-group">
                  ...
                  <b>Change Password?</b><br>
                    <label>
                      <input type="radio" name="passc" id="optionsRadios1" value="y">
                      Yes
                    </label>
                    <label>
                      <input type="radio" name="passc" id="optionsRadios2" value="n" checked>
                      No
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <img src="../assets/dist/img/users/<?php echo $datas['photo'];?>" width="200px">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="group">
                    <option value="moderator" <?php if($datas['group']='moderator'){echo "selected";}?>>Moderator</option>
                    <option value="admin" <?php if($datas['group']='admin'){echo "selected";}?>>Admin</option>
                    <option value="superadmin" <?php if($datas['group']='superadmin'){echo "selected";}?>>Superadmin</option>
                  </select>
                </div>
