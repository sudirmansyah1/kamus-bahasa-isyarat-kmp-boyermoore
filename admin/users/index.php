        ...
        <?php 
          if(isset($_GET['status'])){
            if($_GET['status'] == "add_success"){
              echo "<div class='callout callout-success'><p>User has been added</p></div>";
              ...
              echo "<div class='callout callout-success'><p>User has been deleted</p></div>";
            }
            else if($_GET['status'] == "failed3"){
              echo "<div class='callout callout-danger'><p>Failed to delete user</p></div>";
            }
            else if($_GET['status'] == "failed4"){
              echo "<div class='callout callout-danger'><p>Failed to edit user</p></div>";
            }
            else if($_GET['status'] == "edit_success"){
              echo "<div class='callout callout-success'><p>User has been edited</p></div>";
            }
          }
          ?>
          <div class="box">
            <div class="box-header">
              ...
              <a href="adduser.php" class="btn btn-info btn-sm">Add User</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="assets/dist/img/users/<?php echo $d["photo"]?>" target="_blank"><a href="../assets/dist/img/users/<?php echo $d["photo"]?>" target="_blank"><img src="../assets/dist/img/users/<?php echo $d["photo"]?>" width="30px" style="border-radius: 50%;" alt="<?php echo $d["username"]?>"></a>
                        </td>
