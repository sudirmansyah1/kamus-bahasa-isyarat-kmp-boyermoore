...
<body>
    ...
    <section class="headerkamus">
        <div class="container">
        <?php
                            if($kata!=''){ echo "<h1>Kata yang dicari '".$_GET['kata']."' dengan menggunakan algoritma Boyer Moore</h1>";}
                            else{
    ...
    <!-- END OF HEADER -->
    <!-- KAMUS -->
<section class="kamus"><div class="container"><?php
if($kata!=''){
                ...
                <hr>
                    <div class="card" style="width:100%; border:1px;">
                        ...
                        <?php 
                                            ...
                                            $hasil = $Boyer->SearchString(strip_tags((strtolower($teks['judul']))),$k);
                                           ?>
                ...
                <?php
                                            ...
                                            $result = mysqli_query($koneksi,"select * from kamus order by `judul` asc");
                                            while($row = mysqli_fetch_array($result)){?>
                                                        <hr>
                                                        <div class="card" style="width:100%; border:1px;">
                                                        <img class="card-img-top" src="assets/img/kamus/<?php echo $row['gambar']?>" alt="Card image" style="width:100%">
                                                        <div class="card-body">
